...
describe("favorite blog", () => {
  ...
  test("list of many blogs returns the blog with most likes", () => {
  ...
  test("list with two or more favorites returns the first one", () => {
...
describe("most blogs", () => {
  ...
  test("return the later mentioned author if there is a tie", () => {
...
describe("most likes", () => {
  ...
  test("return the later mentioned author if there is a tie", () => {
    const result = listHelper.mostLikes(listWithTwoTopBloggers);
